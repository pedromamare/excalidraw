  ...
  return {
    ...
    transform(code, id) {
      ...
      @font-face {
        ...
        src: url(${OSS_FONTS_CDN}Assistant/Assistant-Regular.woff2)
            format("woff2"),
      ...
      @font-face {
        font-family: "Assistant";
        src: url(${OSS_FONTS_CDN}Assistant/Assistant-Medium.woff2)
            format("woff2"),
      ...
      @font-face {
        font-family: "Assistant";
        src: url(${OSS_FONTS_CDN}Assistant/Assistant-SemiBold.woff2)
            format("woff2"),
      ...
      @font-face {
        font-family: "Assistant";
        src: url(${OSS_FONTS_CDN}Assistant/Assistant-Bold.woff2)
            format("woff2"),
      ...
      <link
        rel="preload"
        href="${OSS_FONTS_CDN}Excalifont/Excalifont-Regular-a88b72a24fb54c9f94e3b5fdaa7481c9.woff2"
        as="font"
        type="font/woff2"
      ...
      <link
        rel="preload"
        href="${OSS_FONTS_CDN}Nunito/Nunito-Regular-XRXI3I6Li01BKofiOc5wtlZ2di8HDIkhdTQ3j6zbXWjgeg.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
      <link
        rel="preload"
        href="${OSS_FONTS_CDN}ComicShanns/ComicShanns-Regular-9442f8c1c9f00f0d5e4102a78672fad9.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
      <link
        rel="preload"
        href="${OSS_FONTS_CDN}Virgil/Virgil-Regular.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
